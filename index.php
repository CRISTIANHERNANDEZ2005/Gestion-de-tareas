        ...
        if ($_POST['accion'] === 'agregar') {
            if (agregarTarea($titulo, $descripcion, $fecha_limite)) {
                ...
                if (existeTituloTarea($titulo)) {
                    redirectWithMessage("Error: El título '$titulo' ya está en uso. Por favor, elige otro título.", "index.php");
                } else {
                    redirectWithMessage("Error al agregar la tarea. Por favor, inténtelo de nuevo.", "index.php");
                }
            }
            ...
            if (!$idValidation['valid']) {
                redirectWithMessage($idValidation['message'], "index.php");
            } else {
                if (actualizarTarea($id, $titulo, $descripcion, $fecha_limite)) {
                    ...
                    if (existeTituloTareaExcluyendoId($titulo, $id)) {
                        ...
                        redirectWithMessage("Error al actualizar la tarea. Por favor, inténtelo de nuevo.", "index.php");
                    }
                }
            }
        }
    ...
    elseif (isset($_POST['accion']) && $_POST['accion'] === 'eliminar') {
        ...
        if (!$idValidation['valid']) {
            ...
            if (eliminarTarea($id)) {
                ...
                redirectWithMessage("Error al eliminar la tarea. Por favor, inténtelo de nuevo.", "index.php");
            }
        }
    }
}
...
if (isset($_GET['accion']) && $_GET['accion'] === 'editar' && isset($_GET['id'])) {
    ...
    if (!$idValidation['valid']) {
        ...
        if (!$tarea_a_editar) {
            redirectWithMessage("No se encontró la tarea.", "index.php");
        }
    }
}
    ...
    <div class="contenedor-principal">
        ...
        <main>
            <section class="formulario-seccion">
                ...
                <form id="formulario-tareas" action="index.php" method="POST">
                    ...
                    <div class="form-botones">
                        ...
                        <?php if ($tarea_a_editar): ?>
                            <a href="index.php" class="btn btn-secondary" title="Cancelar">
                                <svg width="20" height="20" viewBox="0 0 16 16" fill="currentColor">
                            ...
                            <tbody>
                                <?php foreach ($lista_tareas as $tarea): ?>
                                    <tr>
                                        ...
                                        <td class="acciones">
                                            <a href="index.php?accion=editar&id=<?php echo $tarea['id']; ?>" class="btn-editar" title="Editar tarea">
    ...
    <div id="modal-eliminacion" class="modal">
        <div class="modal-contenido">
            <div class="modal-encabezado">
                ...
                <button type="button" class="btn-cerrar-modal" id="cerrar-modal-eliminacion" title="Cerrar">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
                    </svg>
                </button>
